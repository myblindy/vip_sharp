...
namespace printf
{
    internal static class PrintFImplementation
    {
...
namespace vip_sharp
{
    ...
    {
        public void Format(BipolarArray<char> dest, IEnumerable<char> format, object val)
        {
            var s = printf.PrintFImplementation.sprintf(string.Concat(format), val);
            dest.Set(s);
        }
    }
}
